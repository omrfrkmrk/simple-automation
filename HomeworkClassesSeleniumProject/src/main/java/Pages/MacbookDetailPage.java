...
public class MacbookDetailPage extends BasePage {
	...
	By installmentAmount = By
			.xpath("//*[@id=\"product-detail\"]/div[1]/div/div/div[2]/form/div[2]/label/div[1]/span[2]/span");

	By installmentSixMonths = By
			.xpath("//*[@id=\"product-detail\"]/div[1]/div/div/div[2]/form/div[2]/label/div[2]/a[1]");

	By installmentNineMonths = By
			.xpath("//*[@id=\"product-detail\"]/div[1]/div/div/div[2]/form/div[2]/label/div[2]/a[2]");
	...
	public void CheckPriceForMacbook() {
		String priceStr = elementService.getElement(price).getAttribute("innerHTML");
